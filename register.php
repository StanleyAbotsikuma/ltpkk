...
$sql = "INSERT INTO membership (id,mem_id,mem_firstname,mem_lastname,mem_othernames,mem_gender,mem_current_position,mem_nia_card_number,mem_voter_id,mem_digital_address,mem_contact_address,mem_occupation,mem_telephone,mem_region_hometown,mem_marital_status,mem_email_address,mem_prosecuted_status,mem_reason_for_prosecution,mem_passport_photo,mem_date_registered) VALUES (null,:mem_id,:mem_firstname,:mem_lastname,:mem_othernames,:mem_gender,:mem_current_position,:mem_nia_card_number,:mem_voter_id,:mem_digital_address,:mem_contact_address,:mem_occupation,:mem_telephone,:mem_region_hometown,:mem_marital_status,:mem_email_address,:mem_prosecuted_status,:mem_reason_for_prosecution,:mem_profile_pic,:mem_date_registered)";
